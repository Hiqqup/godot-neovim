...
func _enable_plugin() -> void:
	...
	EditorInterface.set_plugin_enabled(PLUGIN_NAME + "/msgpack", true)
...
func _setup_caret_moved_callback(code_edit: CodeEdit):
	...
	code_edit.caret_changed.connect(func():
		...
		_nvim_connection.send_request("nvim_win_set_cursor",[0,[line,col]] )
		)
...
func _attach_nvim_ui(code_edit: CodeEdit):
	...
	_nvim_connection.send_request("nvim_ui_attach", [terminal_dimensions.x, terminal_dimensions.y,{}])
	
func _nvim_go_to_insert_mode():
	_nvim_connection.send_request("nvim_input", ["i"])
...
func _process_text_edit_gui_input(event: InputEvent):
	if event is InputEventKey and event.is_pressed():
		...
		if parsed : 
			_nvim_connection.send_request("nvim_input", [ parsed])
	pass
...
func _enter_tree() -> void:
	...
	script_editor.editor_script_changed.connect(func(script:Script):
		...
		_nvim_connection.send_request("nvim_command", ['e! ' + file_path])
